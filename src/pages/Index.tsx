  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="relative h-56 overflow-hidden">
        <img src={heroBanner} alt="Voluntários em ação" className="h-full w-full object-cover" />
        <div className="absolute inset-0 hero-overlay" />
        <div className="absolute bottom-0 left-0 right-0 p-5">
          <p className="text-primary-foreground/80 text-xs font-medium tracking-wide uppercase mb-1">Fevereiro 2026</p>
          <h1 className="font-display text-2xl font-bold text-primary-foreground leading-tight">
            Transformando vidas,<br />juntos.
          </h1>
        </div>
      </div>
